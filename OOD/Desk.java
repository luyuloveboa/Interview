...
public class Desk {
	...
	public static class Card{
		int number;
		CardType ct; 
		public Card(int num, CardType c){
			number = num;
			ct =c;
		}
		
		public String toString(){
			return number + ct.toString();
		}
	}
	...
	public Desk() {
		...
		for (int i = 0; i < 13; i++) {
			cards[i] = new Card(i + 1, CardType.HEARTS);
			cards[i + 13] = new Card(i + 1, CardType.DIAMONDS);
			cards[i + 26] = new Card(i + 1, CardType.CLUBS);
			cards[i + 39] = new Card(i + 1, CardType.SPADES);
		}
	}
